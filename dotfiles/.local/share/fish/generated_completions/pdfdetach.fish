# pdfdetach
# Autogenerated from man page /opt/homebrew/share/man/man1/pdfdetach.1
...
complete -c pdfdetach -o cfg -d 'Read  config-file in place of ~/. xpdfrc or the system-wide config file'
