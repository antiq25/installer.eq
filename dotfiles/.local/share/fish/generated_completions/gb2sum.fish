# gb2sum
# Autogenerated from man page /opt/homebrew/share/man/man1/gb2sum.1
complete -c gb2sum -s b -l binary -d 'read in binary mode'
complete -c gb2sum -s c -l check -d 'read checksums from the FILEs and check them'
complete -c gb2sum -s l -l length -d 'digest length in bits; must not exceed the max for the blake2 algorithm and m…'
