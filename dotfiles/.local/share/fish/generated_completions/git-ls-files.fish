# git-ls-files
# Autogenerated from man page /Applications/Xcode-beta.app/Contents/Developer/usr/share/man/man1/git-ls-files.1
...
complete -c git-ls-files -l resolve-undo -d and
