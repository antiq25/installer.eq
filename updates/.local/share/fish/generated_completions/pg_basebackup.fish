...
complete -c pg_basebackup -s t -d 'Instructs the server where to place the base backup'
...
complete -c pg_basebackup -s Z -d 'Requests compression of the backup'
...
complete -c pg_basebackup -l target
complete -c pg_basebackup -o Xstream
complete -c pg_basebackup -o Xfetch -d or
complete -c pg_basebackup -o Xnone
